...
namespace GenericsWithConstraintsSampleAndLab
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Struct ist ein Wertetype -> DataStore<MyStruct> store4 = new DataStore<MyStruct>(); 

            // ist ein Wertetype -> DataStore<int> store5 = new DataStore<int>(); 
